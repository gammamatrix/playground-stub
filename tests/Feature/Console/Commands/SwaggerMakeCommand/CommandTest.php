...
/**
 * \Tests\Feature\Playground\Stub\Console\Commands\SwaggerMakeCommand
 */
...
class CommandTest extends TestCase
{
    public function test_command_without_options_or_arguments(): void
    {
         ...
         */
        $result = $this->artisan('playground:make:swagger');
    ...
    public function test_command_skeleton(): void
    {
         ...
         * @var \Illuminate\Testing\PendingCommand $result
         */
        $result = $this->artisan('playground:make:swagger testing --skeleton --force');
        $result->assertExitCode(0);
    }
}
